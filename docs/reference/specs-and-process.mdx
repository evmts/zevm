...
- CI runs the root release gates documented in [CI And Release Gates](./ci-and-release-gates), including sibling dependency materialization, strict qualification coverage, generated-metadata smoke validation, dirty-worktree preflight, and scheduled/manual external verification
