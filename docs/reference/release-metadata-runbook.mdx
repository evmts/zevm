...
If any checkout, `zig version`, build, qualification command, or Hive smoke fails, the tuple is not valid reproducibility evidence for canonical release claims.
