...
- `eth_accounts`, `eth_coinbase`, `eth_gasPrice`, `eth_maxPriorityFeePerGas`, `eth_blobBaseFee`, `eth_feeHistory`, and `eth_getStorageValues` are trusted-mode only and return `-32010` in light mode.
