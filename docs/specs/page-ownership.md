...
As of `2026-03-31`, all rows below are `verified` for both anchor coverage and nav reconciliation against `mintlify/mint.json`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Start | `index` | `Docs IA Owner` | `docs/specs/prd.md` | `docs/specs/prd.md#1-purpose`; `docs/specs/prd.md#3-product-scope` | `docs/specs/internal/phase-1-product-shape.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: Mintlify-first routing restored for canonical specs/process entry and repository-head source links were demoted to release-audit guidance.` |
| Specs & Policy | `reference/canonical-specs` | `Docs IA Owner` | `docs/specs/prd.md`; `docs/specs/json-rpc-contract.md` | `docs/specs/prd.md#2-normative-documents`; `docs/specs/json-rpc-contract.md#zevm-json-rpc-contract` | `docs/specs/README.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: canonical-spec source index kept public-facing while repository-head GitHub links were explicitly version-bounded for release-specific audits.` |
| Specs & Policy | `reference/specs-and-process` | `Docs IA Owner` | `docs/specs/prd.md`; `docs/specs/json-rpc-contract.md` | `docs/specs/prd.md#2-normative-documents`; `docs/specs/json-rpc-contract.md#zevm-json-rpc-contract` | `docs/specs/README.md`; `docs/specs/docs-first-process.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: process routing now points readers through Canonical Specs and pinned-checkout guidance, and the same-cycle traceability reconciliation requirement is surfaced on the public process page.` |
| Specs & Policy | `reference/release-metadata-runbook` | `Configuration Spec Owner` | `docs/specs/prd.md` | `docs/specs/prd.md#34-release-metadata-and-provenance-contract`; `docs/specs/prd.md#35-release-qualification-and-verification-acceptance-criteria` | `docs/specs/internal/release-metadata-and-installation.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: exact supersession-note template reconciled with PRD 3.4, and qualification framing was rewritten around operator workflow rather than page-maintenance traceability.` |
| Quickstart | `quickstart/installation` | `Configuration Spec Owner` | `docs/specs/prd.md` | `docs/specs/prd.md#33-phase-1-source-build-installation-contract` | `docs/specs/internal/release-metadata-and-installation.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: source-build prerequisites re-anchored to public contract docs and non-contract implementation references removed.` |
...
| Concepts | `concepts/light-mode` | `Runtime/Mode Spec Owner` | `docs/specs/prd.md` | `docs/specs/prd.md#42-light-mode`; `docs/specs/prd.md#10-light-mode-checkpoint-and-history-semantics` | `docs/specs/internal/light-mode-semantics.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: light-mode concept page now routes readers to public configuration/readiness references instead of internal support-doc links.` |
...
| JSON-RPC Reference | `reference/json-rpc/overview` | `JSON-RPC Spec Owner` | `docs/specs/json-rpc-contract.md`; `docs/specs/prd.md` | `docs/specs/json-rpc-contract.md#1-common-types`; `docs/specs/json-rpc-contract.md#4-json-rpc-envelope`; `docs/specs/json-rpc-contract.md#5-errors`; `docs/specs/json-rpc-contract.md#6-selector-and-mode-semantics`; `docs/specs/json-rpc-contract.md#8-trusted-mode-standard-methods`; `docs/specs/json-rpc-contract.md#9-trusted-mode-zevm_-methods`; `docs/specs/json-rpc-contract.md#13-light-mode-methods`; `docs/specs/json-rpc-contract.md#14-unsupported-public-surface`; `docs/specs/prd.md#6-json-rpc-transport`; `docs/specs/prd.md#7-json-rpc-method-surface` | `docs/specs/internal/rpc-support-matrix.md`; `docs/specs/internal/transport-and-error-semantics.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: overview anchors expanded for mode-specific method coverage, the phase-1 light-mode summary corrected to include always-callable zevm_lightSyncStatus, and source routing now points readers through Canonical Specs for pinned-checkout guidance.` |
...
| JSON-RPC Reference | `reference/json-rpc/unsupported-and-deferred` | `JSON-RPC Spec Owner` | `docs/specs/json-rpc-contract.md`; `docs/specs/prd.md` | `docs/specs/json-rpc-contract.md#12-deferred-trusted-helpers`; `docs/specs/json-rpc-contract.md#14-unsupported-public-surface`; `docs/specs/prd.md#32-out-of-scope` | `docs/specs/internal/rpc-support-matrix.md`; `docs/specs/internal/phase-1-product-shape.md` | `verified` | `2026-03-31` | `2026-03-31` | `2026-03-31: maintainer-only tracking links were removed and the contract-change path now stays inside public Canonical Specs and Specs And Process routing.` |
