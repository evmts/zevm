...
Before troubleshooting startup/runtime behavior, confirm [Installation](./installation) prerequisites are satisfied (Zig version, Rust/Cargo, package-manager dependency fetch, and successful source build output at `./zig-out/bin/zevm`).
