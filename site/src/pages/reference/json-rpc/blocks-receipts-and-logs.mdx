...
| `eth_getBlockAccessList` | `[block]` (`BlockNumberOrTagOrHash`) | block access list or `null` | unknown block or retained block without access-list data -> `null`; malformed selector -> `-32602` |
