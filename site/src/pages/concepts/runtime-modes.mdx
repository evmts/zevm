...
The current public runtime/RPC scope remains trusted-first:
...
| Simulation and execution testing (`eth_call`, `eth_estimateGas`, `eth_createAccessList`, `eth_simulateV1`, `testing_buildBlockV1`) | yes | no (`-32010`; these methods are trusted-only in phase 1, and `eth_call` remains a deferred light-mode proof-backed target) |
