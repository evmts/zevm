...
> Prerequisite: complete [Installation](/quickstart/installation) first, including Zig package fetch and a successful source build that produces `./zig-out/bin/zevm`.

## 1. Start Light Mode

Before startup, re-check [Installation](/quickstart/installation) prerequisites (Zig, Rust/Cargo, package-manager dependency pins, successful build).
...
- [Troubleshooting handshake failures](/quickstart/troubleshooting#light-mode-startup-handshake-checks)
