...
export const ZEVM_TARGET: Target = {
  ...
  reviewChecklist: [
    ...
    "REFERENCE IMPLEMENTATIONS — Study tevm-monorepo, lib/hardhat and lib/edr, and lib/foundry anvil for behavior and edge cases before implementing.",
    "SPECS — Use lib/execution-apis/ for JSON-RPC spec, lib/execution-specs/ for EVM behavior, lib/EIPs/ for individual proposals, lib/consensus-specs/ for beacon chain, lib/yellowpaper/ for formal spec.",
    "TESTS — Use lib/ethereum-tests/ for golden test vectors, lib/execution-spec-tests/ for hardfork-specific state tests, lib/hive/ for integration tests.",
  ...
  referenceFiles: [
    ...
    "lib/ethereum-tests/",
    "lib/execution-spec-tests/tests/",
    "lib/EIPs/EIPS/",
    "lib/consensus-specs/specs/",
    "lib/yellowpaper/",
