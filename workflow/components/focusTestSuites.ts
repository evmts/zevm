...
export const focusTestSuites: Record<string, {
  ...
  "cat-1-rpc-server": {
    ...
    setupHints: [
      ...
      "Reference: lib/edr/crates/edr_provider/src/requests/methods.rs for method routing patterns",
      "Spec: lib/execution-apis/ has the official JSON-RPC 2.0 and Engine API specifications",
    ],
    testDirs: ["src/"],
  },
  "cat-2-eth-read": {
    ...
    setupHints: [
      ...
      "Reference: lib/edr/crates/edr_provider/src/requests/eth/ for edge cases and error handling",
    ],
    testDirs: ["src/"],
  },
  "cat-3-eth-call": {
    ...
    setupHints: [
      ...
      "Reference: lib/edr/crates/edr_provider/src/requests/eth/call.rs, ../tevm-monorepo/packages/actions/src/Call/",
    ],
    testDirs: ["src/"],
  },
  "cat-4-eth-send": {
  ...
  "cat-8-state-manip": {
    ...
    setupHints: [
      ...
      "Reference: lib/edr hardhat handlers, tevm anvil handlers",
    ],
    testDirs: ["src/"],
  },
  "cat-9-impersonation": {
  ...
  "test-rlp": {
    ...
    setupHints: [
      "Test vectors are in lib/ethereum-tests/RLPTests/ (JSON format)",
      ...
      "Reference: lib/execution-specs/src/ethereum/rlp.py for the Python reference implementation",
    ],
    testDirs: ["lib/ethereum-tests/RLPTests/", "src/"],
  },
  "test-trie": {
    suites: ["Trie insertion tests", "Trie proof tests", "Trie any-order tests", "Secure trie tests"],
    setupHints: [
      "Test vectors are in lib/ethereum-tests/TrieTests/ (5 fixture files, 25+ vectors)",
      ...
      "Reference: lib/execution-specs/src/ethereum/frontier/trie.py for trie spec",
    ],
    testDirs: ["lib/ethereum-tests/TrieTests/", "src/database/"],
  },
  "test-transaction": {
    suites: ["Transaction validity tests", "Transaction encoding tests", "Signature recovery tests"],
    setupHints: [
      "Test vectors are in lib/ethereum-tests/TransactionTests/ (JSON format)",
      ...
      "Reference: lib/execution-specs/src/ethereum/frontier/transactions.py",
    ],
    testDirs: ["lib/ethereum-tests/TransactionTests/", "src/"],
  },
  "test-blockchain": {
    suites: ["Block execution tests", "Block validation tests", "Chain reorg tests"],
    setupHints: [
      "Test vectors are in lib/ethereum-tests/BlockchainTests/ (full block execution traces)",
      ...
      "Reference: lib/execution-specs/src/ethereum/frontier/fork.py for block processing spec",
    ],
    testDirs: ["lib/ethereum-tests/BlockchainTests/", "src/"],
  },
  "test-difficulty": {
    suites: ["Frontier difficulty tests", "Homestead difficulty tests", "Byzantium+ difficulty tests"],
    setupHints: [
      "Test vectors are in lib/ethereum-tests/DifficultyTests/ organized by hardfork",
      ...
      "Reference: lib/yellowpaper/ for formal difficulty spec, lib/execution-specs/ for Python impl",
    ],
    testDirs: ["lib/ethereum-tests/DifficultyTests/"],
  },
  "test-abi": {
    suites: ["ABI encoding tests", "ABI decoding tests"],
    setupHints: [
      "Test vectors are in lib/ethereum-tests/ABITests/ (JSON format)",
    ...
    testDirs: ["lib/ethereum-tests/ABITests/"],
  },
  "test-eof": {
    suites: ["EOF validation tests", "EOF container tests"],
    setupHints: [
      "Test vectors are in lib/ethereum-tests/EOFTests/ (EVM Object Format, EIP-3670)",
      "EOF validation happens at deploy time — check guillotine-mini EVM for EOF support",
      "Reference: lib/EIPs/EIPS/eip-3670.md for the spec",
    ],
    testDirs: ["lib/ethereum-tests/EOFTests/"],
  },
  "test-state-frontier": {
    suites: ["Frontier state tests", "Homestead state tests", "Byzantium state tests", "Constantinople state tests", "Istanbul state tests"],
    setupHints: [
      "Execution spec tests are in lib/execution-spec-tests/tests/{frontier,homestead,byzantium,constantinople,istanbul}/",
      ...
      "Reference: lib/execution-specs/src/ethereum/ for Python reference per hardfork",
    ],
    testDirs: ["lib/execution-spec-tests/tests/", "src/"],
  },
  "test-state-berlin": {
    suites: ["Berlin state tests", "Shanghai state tests"],
    setupHints: [
      "Execution spec tests are in lib/execution-spec-tests/tests/{berlin,shanghai}/",
  ...
  "test-state-cancun": {
    ...
    setupHints: [
      "Execution spec tests are in lib/execution-spec-tests/tests/{cancun,prague}/",
  ...
  "test-hive-rpc": {
    ...
    setupHints: [
      "Hive tests are in lib/hive/simulators/ethereum/ — these are integration tests",
      ...
      "Reference: lib/execution-apis/ for the official JSON-RPC specification",
    ],
    testDirs: ["lib/hive/simulators/ethereum/", "src/"],
  },
};
