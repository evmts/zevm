...
## PRD 3.5 Qualification Mapping (Metadata-Backed Candidates)

For page-ownership and qualification traceability, treat this runbook as the public-doc anchor for PRD section [3.5 release qualification and verification acceptance criteria](https://github.com/evmts/zevm/blob/main/docs/specs/prd.md#35-release-qualification-and-verification-acceptance-criteria) expectations that apply to metadata-backed candidates:
