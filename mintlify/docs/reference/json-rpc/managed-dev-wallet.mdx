...
description: Trusted-mode managed dev-wallet behavior summary: mnemonic, derivation root, addresses, private keys, and signing behavior.
---

# Managed Dev Wallet (Trusted Mode)

This page summarizes ZEVM trusted mode's deterministic managed dev-wallet behavior.
